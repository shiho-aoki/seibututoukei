...
data1990 = pd.read_csv(r'data\Nagano1990.csv')
data_humidity1 = data1990['humidity'].values.tolist()

data1995 = pd.read_csv(r'data\Nagano1995.csv')
data_humidity2 = data1995['humidity'].values.tolist()

data2000 = pd.read_csv(r'data\Nagano2000.csv')
data_humidity3 = data2000['humidity'].values.tolist()

data2005 = pd.read_csv(r'data\Nagano2005.csv')
data_humidity4 = data2000['humidity'].values.tolist()

data2010 = pd.read_csv(r'data\Nagano2010.csv')
...
with open ('data/ans/gause_humidity_Nagano'+titile+'w.csv', 'w') as f:
    writer = csv.writer(f)
...
plt.xlabel("時間(day)")
plt.ylabel("湿度(%)")
plt.title('Humidity signal prediction by Gaussian process(Nagano)', fontsize=20)
