...
temp_rolling1 = ma.MovingAverage(data1900['temp'])
vap_pressure_rolling1 = ma.MovingAverage(data1900['vap_pressure'])
humidity_rolling1 = ma.MovingAverage(data1900['humidity'])
